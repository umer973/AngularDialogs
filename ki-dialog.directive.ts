...
import { document, window, isBs3, Utils } from '../ngxtools/utils';
import { ModalBackdropComponent } from './ki-dialog-backdrop.component';
import {
  CLASS_NAME, DISMISS_REASONS, modalConfigDefaults, ModalOptions
} from './ki-dialog-options.class';
import { ComponentLoader,ComponentLoaderFactory } from '../ngxtools/component-loader';
...
export class KIDialogDirective implements OnDestroy, OnInit {
  ...
  @Output()
  onShow: EventEmitter<KIDialogDirective> = new EventEmitter<KIDialogDirective>();
  /** This event is fired when the modal has been made visible to the user
   * (will wait for CSS transitions to complete)
   */
  @Output()
  onShown: EventEmitter<KIDialogDirective> = new EventEmitter<KIDialogDirective>();
  /** This event is fired immediately when
   * the hide instance method has been called.
   */
  @Output()
  onHide: EventEmitter<KIDialogDirective> = new EventEmitter<KIDialogDirective>();
  /** This event is fired when the modal has finished being
   * hidden from the user (will wait for CSS transitions to complete).
   */
  @Output()
  onHidden: EventEmitter<KIDialogDirective> = new EventEmitter<KIDialogDirective>();
