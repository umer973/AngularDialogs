...
import { ModalBackdropComponent } from './ki-modal-backdrop.component';
import {
  CLASS_NAME, DISMISS_REASONS, modalConfigDefaults, ModalOptions
} from './ki-modal-options.class';
...
export class KIModalDirective implements OnDestroy, OnInit {
  ...
  @Output()
  onShow: EventEmitter<KIModalDirective> = new EventEmitter<KIModalDirective>();
  /** This event is fired when the modal has been made visible to the user
   * (will wait for CSS transitions to complete)
   */
  @Output()
  onShown: EventEmitter<KIModalDirective> = new EventEmitter<KIModalDirective>();
  /** This event is fired immediately when
   * the hide instance method has been called.
   */
  @Output()
  onHide: EventEmitter<KIModalDirective> = new EventEmitter<KIModalDirective>();
  /** This event is fired when the modal has finished being
   * hidden from the user (will wait for CSS transitions to complete).
   */
  @Output()
  onHidden: EventEmitter<KIModalDirective> = new EventEmitter<KIModalDirective>();
